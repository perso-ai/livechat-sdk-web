...
export function getAllDefaultClientTools(): Array<PersoAILiveChatSDK.ChatTool> {
    // This ClientTool tells you the square of the queried number.
    const clientTool1 = new PersoAILiveChatSDK.ChatTool(
        'get_square_number',
    ...
    const clientTool2 = new PersoAILiveChatSDK.ChatTool(
        'get_current_weather',
    ...
    const clientTool3 = new PersoAILiveChatSDK.ChatTool(
        'show_settings',
    ...
    const clientTool4 = new PersoAILiveChatSDK.ChatTool(
        'show_map',
    ...
    return [clientTool1, clientTool2, clientTool3, clientTool4];
}
